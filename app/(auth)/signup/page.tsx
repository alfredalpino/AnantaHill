  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-[2rem] border border-secondary shadow-premium p-8 md:p-10 space-y-8">
      <div className="text-center space-y-2">
        <p className="text-xs font-bold tracking-[0.2em] uppercase text-primary">Join us</p>
        <h1 className="text-3xl md:text-4xl font-display font-black text-text-primary">Create an account</h1>
        <p className="text-text-muted text-sm font-medium">Create your account with mobile OTP in seconds.</p>
      </div>
      ...
      <form onSubmit={step === 'phone' ? handleSendOtp : handleVerifyOtp} className="space-y-5">
        <div className="space-y-1.5">
          <label htmlFor="signup-name" className="text-sm font-bold text-text-primary ml-1">
            Full name
          </label>
          <input
            id="signup-name"
        ...
        <div className="space-y-1.5">
          <label htmlFor="signup-phone" className="text-sm font-bold text-text-primary ml-1">
            Mobile number
          </label>
          <input
            id="signup-phone"
        ...
        {step === 'otp' && (
          ...
          >
            <label htmlFor="signup-otp" className="text-sm font-bold text-text-primary ml-1">
              OTP
            </label>
            <input
              id="signup-otp"
